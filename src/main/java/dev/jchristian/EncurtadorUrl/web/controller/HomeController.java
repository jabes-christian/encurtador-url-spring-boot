...
import dev.jchristian.EncurtadorUrl.domain.models.PagedResult;
    ...
    public String deleteUrls(
        ...
        if (ids == null || ids.isEmpty()) {
            redirectAttributes.addFlashAttribute(
                    "errorMessage", "Nenhuma URL selecionada para exclusão");
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("successMessage",
                    "As URLs selecionadas foram excluídas com sucesso");
        } catch (Exception e) {
            redirectAttributes.addFlashAttribute("errorMessage",
                    "Erro ao excluir URLs: " + e.getMessage());
        }
        return "redirect:/my-urls";
    }
